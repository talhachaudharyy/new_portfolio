  ...
  return (
    <div className="bg-white">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <BsGithub size={25} className='mr-5 cursor-pointer hover:fill-gray-700' color='#666666' />
                  </a>       
                  <a
                    href="https://www.linkedin.com/in/talhachaudharyy/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <BsLinkedin size={25} className='mr-5 cursor-pointer hover:fill-gray-700' color='#666666' />
                  </a>
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#43dd88] to-[#89fcc6] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            ...
            Versatile Full Stack Web and Mobile Application Developer with 4 years of experience in React, React Native, and Python (Django)</p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a  target='_blank' href="https://www.linkedin.com/in/talhachaudharyy/" className="text-sm font-m px-3.5 py-3 font-semibold leading-6 text-gray-900">
